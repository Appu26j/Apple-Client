...
public class EntityWither extends EntityMob implements IBossDisplayData, IRangedAttackMob
{
    ...
    {
        super.entityInit();
        this.dataWatcher.addObject(17, IntegerCache.getInteger(0));
        this.dataWatcher.addObject(18, IntegerCache.getInteger(0));
        this.dataWatcher.addObject(19, IntegerCache.getInteger(0));
        this.dataWatcher.addObject(20, IntegerCache.getInteger(0));
    }

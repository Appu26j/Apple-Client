...
public abstract class Entity implements ICommandSender
{
    ...
    {
        if (this.isSprinting() && this.onGround && !this.isInWater())
        {
    ...
    {
        float f = MathHelper.cosNoFastMath(-yaw * 0.017453292F - (float)Math.PI);
        float f1 = MathHelper.sinNoFastMath(-yaw * 0.017453292F - (float)Math.PI);
        float f2 = -MathHelper.cosNoFastMath(-pitch * 0.017453292F);
        float f3 = MathHelper.sinNoFastMath(-pitch * 0.017453292F);

...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void renderItem(ItemStack stack, ItemCameraTransforms.TransformType cameraTransformType)
    {
        ...
        {
            IBakedModel ibakedmodel = this.itemModelMesher.getItemModel(stack);
            this.renderItemModelTransform(stack, null, ibakedmodel, cameraTransformType);
        }
    }
    ...
    public void renderItemModelForEntity(ItemStack stack, EntityLivingBase entityToRenderFor, ItemCameraTransforms.TransformType cameraTransformType)
    {
        if (stack != null && entityToRenderFor != null)
        {
            ...
            this.renderItemModelTransform(stack, entityToRenderFor, ibakedmodel, cameraTransformType);
            this.modelLocation = null;
        }
    }

    protected void renderItemModelTransform(ItemStack stack, EntityLivingBase entityToRenderFor, IBakedModel model, ItemCameraTransforms.TransformType cameraTransformType)
    {
        this.textureManager.bindTexture(TextureMap.locationBlocksTexture);

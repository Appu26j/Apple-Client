...
public class BlockModelRenderer
{
    ...
    public static class AmbientOcclusionFace
    {
        ...
        public void updateVertexBrightness(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, EnumFacing facingIn, float[] quadBounds, BitSet boundsFlags)
        {
            ...
            boolean flag = !blockAccessIn.getBlockState(blockpos1.offset(facingIn)).getBlock().isVisuallyOpaque() || blockAccessIn.getBlockState(blockpos1.offset(facingIn)).getBlock().getLightOpacity() == 0;
            boolean flag1 = !blockAccessIn.getBlockState(blockpos2.offset(facingIn)).getBlock().isVisuallyOpaque() || blockAccessIn.getBlockState(blockpos2.offset(facingIn)).getBlock().getLightOpacity() == 0;
            boolean flag2 = !blockAccessIn.getBlockState(blockpos3.offset(facingIn)).getBlock().isVisuallyOpaque() || blockAccessIn.getBlockState(blockpos3.offset(facingIn)).getBlock().getLightOpacity() == 0;
            boolean flag3 = !blockAccessIn.getBlockState(blockpos4.offset(facingIn)).getBlock().isVisuallyOpaque() || blockAccessIn.getBlockState(blockpos4.offset(facingIn)).getBlock().getLightOpacity() == 0;
            float f4;
            int i1;

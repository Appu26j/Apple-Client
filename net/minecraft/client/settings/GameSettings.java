...
public class GameSettings
{
    ...
    public void setOptionFloatValue(GameSettings.Options settingsOption, float value)
    {
        ...
        if (settingsOption == GameSettings.Options.CHECK_FOR_UPDATES)
        {
                ...
                if (this.optionsFile.exists())
                {
                    ...
                    while ((s = bufferedreader.readLine()) != null)
                    {
                        try
                        {
                            ...
                            if (astring[0].equals("checkForUpdates"))
                            {
                                this.checkForUpdates = astring[1].equals("true");
                            }
    ...
    public void saveOptions()
    {
        ...
        try
        {
            ...
            printwriter.println("checkForUpdates:" + this.checkForUpdates);
    ...
    public static enum Options
    {
        ...
        CHECK_FOR_UPDATES("Check for updates", false, true),

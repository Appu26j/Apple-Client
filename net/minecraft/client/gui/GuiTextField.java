    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
                ...
                FixedFontRenderer.drawStringWithShadow(s1, l, i1, 8, -1973791);
                j1 = (int) (l + FixedFontRenderer.getStringWidth(s1, 8));
            }
            ...
            {
                j1 = this.fontRendererInstance.drawStringWithShadow(s.substring(j), (float) j1 + 1, (float)i1, i);
            }
